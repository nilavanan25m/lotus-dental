    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center">
              <img src="/logo.png" alt="Lotus Dental Group" className="h-12 brightness-200" />
            </div>
            <p className="mt-4 text-gray-400">
              Providing quality dental care and creating beautiful smiles since 2000.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Lotus Dental Group. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
